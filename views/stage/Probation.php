...
<div class="wrap" id="white">
    ...
    <div class="table-wrapper">
        ...
        <table class="table table-striped table-hover table-responsive-lg" id="wtf1">
            <thead>
                <tr>
                    <th style="text-align:center"><label class="label">
                            <input type="checkbox" class="label__checkbox" id="selectAll8" value="" />
            ...
            <tbody>
                <?php
                $sql123 = "SELECT * FROM `applyjob` natural join candidate WHERE applyjob.candidateStatus=9 AND applyjob.candidateDrop='0' AND applyjob.jobId=$xx order by applyjob.applyId";
                            ...
                            <div col-4>
                                <div class="wrapper" id="dropt">
                                    <div class="icon move">
                                        ...
                                        <button type="button" onclick="listdropCandidate(9,'<?php echo $email ?>','<?php echo $xx ?>')"><i class="fas fa-user-slash"></i></button>
                                    </div>
                                </div>
